...
class PhoneDetails():
        ...
        for i in tr:
            try:
                if i.td.a.string.lower() == "os" or (i.td.a.string.lower() == "operating system") :
                    self.operatingSystem = i.findAll('td')[1].string
                    break        
            except Exception:
                pass
    def findModel(self):#completed
        try:
            self.model = self.page.h1.string
                ...
                if i.td.a.string.lower() == "primary" or (i.td.a.string.lower() == "primary camera") :
                    ...
                    if k == []:
                        ...
                        if l != []:
                            ...
                            if l != []:
                                self.primaryCameraResolution = l[0][1]
                    break                  
            except Exception as e:
                pass
                ...
                if i.td.a.string.lower() == "secondary" or (i.td.a.string.lower() == "secondary camera") :
                    ...
                    if k == []:
                        ...
                        if l != []:
                            ...
                            if l != []:
                                self.secondaryCameraResolution = l[0][1]
                    break                  
            except Exception:
                pass
    ...
    def findDimensions(self):   #completed
        ...
        if dimList != []:
            try:
                self.length = dimList[0][0]
                self.width = dimList[1][0]
                self.height = dimList[2][0]
            except Exception:
